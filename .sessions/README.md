...
- [ ] `📊 Model:` line filled at FAMILY level only (e.g. `claude-fable-5`, `claude-opus-4-8`) — never a snapshot/full model ID, and model IDs never go in commit messages or PR bodies either.
