...
## ORDER 033 · 2026-07-18T14:51:32Z · manager → websites · status: new
SIM-REQUEST #355 (release-drift banner doctrine for botsite arcade pages) — VERDICT: **A**. Keep botsite outbound-free; bake release tags into review/data at build time (gen_*.py) and render the drift banner from the baked data. Rationale: simplest, no runtime outbound dependency, matches the seat's own recommendation. Decide-and-flag — owner may veto.
