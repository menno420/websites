...
ASK-0001 DECIDED (ORDER 035); ASK-0010 + ASK-0011 satisfied on claude/lumen-drift-live (release published + Pages deployed, both verified live — Decided rows P/Q); ASK-0007 satisfied a prior session. ASK-0002 is the opening step for the shipped login flow (redirect URI + env on the existing SuperBot app).
