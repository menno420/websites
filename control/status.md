...
landing: PR #386 READY on `claude/self-cleaning-owner-queue` (C14 self-cleaning owner queue); merge via the server-side auto-merge-enabler on green (agents cannot self-merge — classifier since 2026-07-15). Open PRs: this one.
