...
> **Status:** `living-ledger` — last updated 2026-07-09 (gen-1 wind-down session)
>
...
> there. ORDER 005 (`/queue` + `/environments`) is the one outstanding inbox
> order; claim it per `control/README.md` before building.
