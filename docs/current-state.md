...
- Quality gates: the `quality` CI workflow (`.github/workflows/quality.yml`) —
  ...
  vendored `bootstrap.py` is kit **v1.12.1** (stepwise §4.3 upgrades
  v1.6.0 → v1.7.0 (#62) → v1.7.1 → v1.8.0 → v1.9.0 (#101) → v1.10.0
  (#105) → v1.10.1 (#113) → v1.11.0 (#129) → v1.12.0 (#146) → v1.12.1 (#155); this passage said v1.6.0 until 2026-07-11 — verified against the
...
- **2026-07-11 continuous-mode chain (manager Q-0265): slices #69 → #139 +
  ...
  - **Kit:** v1.6.0 → v1.12.1 stepwise; ORDER 010 (model-line doctrine)
