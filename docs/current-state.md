...
> **Status:** `living-ledger` — last updated 2026-07-13 (coordinator ender truth sweep: the 2026-07-12→13 overnight ORDER 022 run + morning orders 023–026; suite 1206; bake pipeline reality)
>
...
- Quality gates: the `quality` CI workflow (`.github/workflows/quality.yml`) —
  ...
  (#105) → v1.10.1 (#113) → v1.11.0 (#129) → v1.12.0 (#146) → v1.12.1 (#155) → v1.13.0 (#164) → v1.14.0 (#171) → v1.15.0 (#199); this passage said v1.6.0 until 2026-07-11 — verified against the
