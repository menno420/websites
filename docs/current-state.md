...
> **Status:** `living-ledger` — last updated 2026-07-17 (fresh-start cleanup).
> The Claude Code Projects EAP goes **read-only 2026-07-21** (read-only
> Tuesday); the frozen draft backlog (#371–#380) was **cleared 2026-07-17**;
> the autonomous apparatus is being **wound down** and the Project will be
> **recreated**. main `ecbe2bf` (#383); open PRs: **none**; last full
> four-suite run **1588** (2026-07-16, grown since with #371–#383); kit v1.17.0.
>
...
- **The EAP is winding down.** The Claude Code Projects EAP goes
  **read-only on 2026-07-21 (read-only Tuesday)**; a ~2026-07-15
  permission-classifier change already **froze autonomous merges** — agents
  can no longer ready-flip or REST/MCP-merge, which is exactly what stranded
  the eight green drafts. The **autonomous apparatus is being retired** and
  the **Project will be recreated** fresh. The retirement set (the
