...
- `any` · **Railway variable WRITES are harness-denied before the request ever leaves the session — and would be DISHONEST even if they worked** (ORDER 026 discovery).…
